...
namespace Unity.InstantGame
{
    ...
    class IGBuildPostprocessor : IPostprocessBuildWithReport
    {
        ...
        private static void PrepareEngineDir(string abiStr)
        {
            ...
            if (File.Exists(srcDir + "/libmono-native.so"))
                File.Move(srcDir + "/libmono-native.so", engineDir + "/libmono-native.so");
        ...
        private static void GenerateIconFile()
        {
            ...
            try
            {
                ...
                UnityEngine.Object.DestroyImmediate(iconReadable);
                UnityEngine.Object.DestroyImmediate(iconMimap);
                UnityEngine.Object.DestroyImmediate(iconScaled);
            }
            catch
            {
