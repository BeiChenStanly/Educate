...
namespace Unity.InstantGame
{
    public class IGBuildPipeline
    {
        ...
        public static bool UploadWeChatDataFile(string dataFilePath) 
        {
            ...
            //Code folder for .net 8
            var srcCodeFolder = Path.Combine(outputDir, "Code");
            var destCodeFolder = Path.Combine(ASBuildConstants.k_CustomCloudAssetsPath, "Code");
            CopyDirectory(srcCodeFolder, destCodeFolder);
